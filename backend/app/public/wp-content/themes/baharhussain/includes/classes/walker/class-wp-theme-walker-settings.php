...
class THS_Walker_Settings {
		...
		<div id="my-plugin-div">
			...
			<p class="button-controls">
				<span class="add-to-menu">
					<input type="submit"<?php wp_nav_menu_disabled_check( $nav_menu_selected_id ); ?> class="button-secondary submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu', 'baharhussain' ); ?>" name="add-my-plugin-menu-item" id="submit-my-plugin-div" />
	...
	/**
	 * Init THS_Walker_Acf_Settings Class.
	 *
	 * @return void
	 */
	public function acf_init_location_types() {
		...
		if ( function_exists( 'acf_register_location_type' ) ) {
			acf_register_location_type( '\THS\Walker\Settings\ACF\THS_Walker_Acf_Settings' );
			if ( is_multisite() ) {
				acf_register_location_type( '\THS\Walker\Settings\ACF\THS_Acf_Multisite_Support' );
			}
		}
	}
}
