...
class Acf_Field_Block_Title extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Block Title', 'baharhussain' );
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Block Title)', 'baharhussain' ),
				'instructions' => __( 'Customize the Block Title input instructions', 'baharhussain' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( HTML Tag)', 'baharhussain' ),
				'instructions' => __( 'Customize the HTML tag input instructions', 'baharhussain' ),
				'type'         => 'text',
