...
class Acf_Field_Spacers extends \acf_field {
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Margin From Top)', 'baharhussain' ),
				'instructions' => __( 'Customize the Margin From Top input instructions', 'baharhussain' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( Margin From Bottom)', 'baharhussain' ),
				'instructions' => __( 'Customize the Margin From Bottom input instructions', 'baharhussain' ),
				'type'         => 'text',
